...
SILENCE_THRESHOLD    = float(os.getenv("VEXYL_STT_SILENCE_THRESHOLD", "0.015"))   # RMS energy threshold
MIN_SPEECH_DURATION  = float(os.getenv("VEXYL_STT_MIN_SPEECH_DURATION", "0.3"))     # seconds of speech before attempting transcription
SILENCE_DURATION     = float(os.getenv("VEXYL_STT_SILENCE_DURATION", "0.6"))     # seconds of silence to consider utterance complete
MAX_BUFFER_DURATION  = float(os.getenv("VEXYL_STT_MAX_BUFFER_DURATION", "12.0"))    # force transcription after this many seconds
